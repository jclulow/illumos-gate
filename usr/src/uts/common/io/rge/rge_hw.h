...
#define	RX_ACCEPT_BROADCAST_PKT		0x00000008
#define	RX_ACCEPT_MULTICAST_PKT		0x00000004
#define	RX_ACCEPT_MAC_MATCH_PKT		0x00000002
#define	RX_ACCEPT_ALL_PKT		0x00000001
